...
function contactMeText(detailContainer) {
    ...
    revokeText.innerText = 'Tired throwing pebbles on lake/river? and want to get your own website? well you are always welcome.'
...
function address(detailContainer) {
    ...
    addressText.innerText = '1234, Random Road, Random Town, Random State, India 123456';
